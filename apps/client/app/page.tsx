    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 p-4">
      ...
      {isLoggedIn ? (
        ...
        <div className="flex gap-4">
          <Link
            href="/login"
            className="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium hover:bg-gray-100 hover:text-white dark:border-gray-700 dark:hover:bg-gray-800"
          >
            Log in
          </Link>
          <Link
